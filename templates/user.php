    ...
    <section class="card" id="edit_profile">
        ...
        <form id="profile_info" action="../actions/action_edit_profile.php" method="post" enctype="multipart/form-data">
            ...
            <section class="form_entry" id="username">
                ...
                <input id="username_input" type="text" name="newUsername" value=<?= htmlentities($user['username']) ?>>
            </section>
            <section class="form_entry" id="email">
                <label for="email_input">Email</label>
                <input id="email_input" type="text" name="email" value=<?= htmlentities($user['email']) ?>>
            </section>
            <section class="form_entry" id="first_name">
                <label for="first_name_input">First name</label>
                <input id="first_name_input" type="text" name="firstName" value=<?= htmlentities($user['firstName']) ?>>
            </section>
            <section class="form_entry" id="last_name">
                <label for="last_name_input">Last name</label>
                <input id="last_name_input" type="text" name="lastName" value=<?= htmlentities($user['lastName']) ?>>
            </section>
